...
class SpaceIpParsingTest {
  ...
  fun parsesPrimarySpaceTag() {
    ...
    assertEquals("广东", BiliSpaceApi.parseSpaceIpLocation(card))
  }
  ...
  fun fallsBackToBottomSpaceTag() {
    ...
    assertEquals("上海", BiliSpaceApi.parseSpaceIpLocation(card))
  }

  @Test
  fun missingTagsStayHidden() {
    assertEquals("", BiliSpaceApi.parseSpaceIpLocation(JSONObject()))
  }
}
